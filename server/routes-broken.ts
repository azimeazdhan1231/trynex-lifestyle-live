...
// Removed caching imports as we're using direct Supabase fetching
...
// Direct API access without complex caching

// Remove all static/dummy data - using only authentic Supabase data
  {
    id: '1',
