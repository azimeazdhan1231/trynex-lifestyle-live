...
import { Package, Users, TrendingUp, ShoppingCart, Star, DollarSign, LogOut } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="orders">অর্ডার ({totalOrders})</TabsTrigger>
            <TabsTrigger value="products">পণ্য ({totalProducts})</TabsTrigger>
          </TabsList>
