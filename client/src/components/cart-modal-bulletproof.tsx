    ...
    <>
      <UnifiedModalBase
        ...
        title={
          <>
            🛒 আপনার কার্ট
            <span className="bg-primary/20 text-primary px-2 py-1 rounded-full text-sm font-medium ml-2">
              {cart.length}টি পণ্য
            </span>
          </>
        }
        description="আপনার শপিং কার্টে থাকা পণ্যসমূহ দেখুন এবং পরিচালনা করুন"
        body={
          cart.length === 0 ? (
            <div className="text-center py-12">
