                  ...
                  <div className="space-y-6 mt-6">
                    ...
                    <div>
                      ...
                      <Select value={filters.category} onValueChange={(value) => updateFilter('category', value)}>
                        ...
                        <SelectContent>
                          <SelectItem value="all_categories">সব ক্যাটেগরি</SelectItem>
                ...
                {categories.slice(0, 3).map((category) => (
                  <Button
                    ...
                    onClick={() => updateFilter('category', 
                      filters.category === category.name ? 'all_categories' : category.name
                    )}
                ...
                {filters.category && filters.category !== 'all_categories' && (
                  <Badge variant="secondary" className="flex items-center gap-1">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => updateFilter('category', 'all_categories')}
                      className="p-0 h-auto ml-1"
                    >
                      <X className="w-3 h-3" />
                    </Button>
